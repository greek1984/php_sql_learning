...
$career = [
	[
	 	'role' => 'QA Engeneer',
        'period' => '12.2013 - 08.2014',
        'description' => 'testing mobile applications manually and automatically',
    ],
    [
    	'role' => 'tester for 3D action games',
        'period' => '09.2014 - 06.2017',
        'description' => 'identifying errors and shortcomings in 3D action games 			produced by an enthusiast studio',
    ],
    [
    	'role' => 'smart home system tester',
        'period' => '01.2018 - 05.2021',
        'description' => 'testing of systems such as "smart home" using the 				developments of the contractor company',
    ],
];  
?>
<!DOCTYPE html>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $career[$i]['role']?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $career[$i]['period']?></h6>
            <p><?php echo $career[$i]['description']?></p>
            <hr>
          </div>
          <?php endfor;?>
